...
export default function AboutUs() {
  const aboutData = {
    ...
    subtitle:
      'آفرینش کیف‌هایی برای زندگی، با عشق به هنر قهوه‌دوزی و احترام به اصالت.',
    mission:
      'ماموریت ما احیای هنر قهوه‌دوزی دست‌ساز و عرضه محصولاتی است که نه تنها کاربردی باشند، بلکه میراثی ارزشمند برای نسل‌های آینده تبدیل شوند.',
    vision:
      'تصور ما جهانی است که در آن هرکس ارزش کیفیت، اصالت و داستان پشت یک محصول دست‌ساز را درک می‌کند و آن را به کالای مصرفی بی‌هویت ترجیح می‌دهد.',
