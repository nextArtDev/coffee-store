...
export const CellActions: React.FC<CellActionsProps> = ({ billboardId }) => {
  const path = usePathname()

  const [formState, deleteAction, pending] = useActionState(
    deleteBillboard.bind(null, path, billboardId as string),
    {
      errors: {},
    }
  )
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start">
          ...
          <Link
            ...
            href={`/dashboard/categories/${billboardId}`}
          >
