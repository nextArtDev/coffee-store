  ...
  return (
    <div className="flex-col">
      <div className="flex-1 flex items-center justify-between space-y-4 p-8 pt-6">
        <Heading
          title={`دسته‌بندی (${formattedBillboard?.length})`}
      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        ...
        <Suspense fallback={<DataTableSkeleton />}>
          {!!categoriesResponse.categories?.length && !!formattedBillboard && (
            <BillboardDataTable
              formattedBillboard={formattedBillboard}
              page={page}
              pageSize={pageSize}
    ...
    //       </>
    //     }
    //     modalChildren={<BillboardDetails />}
